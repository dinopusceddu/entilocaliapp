...
export const getFadFieldDefinitions = (norme: NormativeData): Array<FieldDefinition & { key: keyof FondoAccessorioDipendenteData; section: 'stabili' | 'vs_soggette' | 'vn_non_soggette' | 'fin_decurtazioni' | 'cl_limiti' }> => [
    ...
    { 
      ...
      descrizioneFunzionale: "Riduzione obbligatoria del fondo dovuta al conglobamento di una quota dell'indennità di comparto nello stipendio tabellare a partire dal 01.01.2026. [Nota di trasparenza]: La riduzione stabile non deve essere interpretata come nuovo spazio libero di alimentazione del fondo ai fini dei limiti di spesa dell'Art. 23 c. 2.",
      quandoSiUsa: "Obbligatoriamente nella costituzione del fondo 2026 e anni successivi.",
      fonteDato: "Tabella C allegata al CCNL 23.02.2026, calcolata sul personale in servizio al 01.01.2026.",
      effettoLimiti: "Riduce l'ammontare delle risorse stabili soggette al limite Art. 23, comma 2.",
      erroriFrequenti: "Mancata applicazione della decurtazione o calcolo su una platea di personale errata.",
      operationalWarning: "Assicurarsi che la riduzione sia compensata dall'incremento corrispondente della spesa per stipendi tabellari.",
      tipoDato: 'automatico'
    },
    { 
...
export const getDistribuzioneFieldDefinitions = (norme: NormativeData): Array<{
  ...
  livelloAttenzione?: 'info' | 'warning' | 'critical';
    ...
    { 
      ...
      section: 'Utilizzi Parte Stabile (Art. 80 c.1)',
    ...
    { 
      ...
      descrizioneFunzionale: "Quota fissa e continuativa spettante a tutto il personale del comparto, finanziata integralmente dalle risorse stabili del fondo.",
      quandoSiUsa: "Per la remunerazione mensile della specifica indennità prevista dal contratto nazionale.",
      fonteDato: "Calcolo automatico basato sulla consistenza del personale in servizio (Full Time Equivalent).",
      effettoLimiti: "Nessuno (voce di puro utilizzo). [Nota 2026]: Dal 2026 una quota di questa indennità viene conglobata nel tabellare, riducendo corrispondentemente l'utilizzo del fondo.",
      erroriFrequenti: "Calcolare l'indennità su personale non appartenente al comparto Funzioni Locali.",
      operationalWarning: "Verificare la corrispondenza con i valori tabellari aggiornati dai CCNL.",
      tipoDato: 'automatico'
    },
    { 
    ...
    { 
      ...
      section: 'Utilizzi Parte Variabile (Art. 80 c.2)',
