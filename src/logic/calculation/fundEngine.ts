...
export const calculateFundCompletely = (input: NormalizedInput, normativeData: NormativeData): CalculationResult => {
  ...
  // Escludiamo Segretario e Dirigenza dal 'valoreSoggetto' per invarianza con le vecchie stampe/test.
  const fad_soggette = fondi.dipendente?.cl_totaleParzialeRisorsePerConfrontoTetto2016 !== undefined 
    ? fondi.dipendente.cl_totaleParzialeRisorsePerConfrontoTetto2016
    : FinancialMath.sumAll(fadRes.sommaStabiliSoggetteLimite, fadRes.sommaVariabiliSoggette_Dipendenti);
