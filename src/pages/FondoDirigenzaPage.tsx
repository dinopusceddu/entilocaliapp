  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <Card title="RISORSE STABILI" className="mb-6" isCollapsible={true} defaultCollapsed={false}>
        ...
        <FundingItem<FondoDirigenzaData> id="st_art57c2a_CCNL2020_riaPersonaleCessato2020" description="La RIA del personale dirigenziale cessato fino al 31 dicembre del 2020." riferimentoNormativo={RIF_CCNL_DIR_17122020_ART57C2A} value={data.st_art57c2a_CCNL2020_riaPersonaleCessato2020} onChange={handleChange} />
      ...
      <Card title="RISORSE VARIABILI" className="mb-6" isCollapsible={true} defaultCollapsed={true}>
        ...
        <FundingItem<FondoDirigenzaData> id="va_art39c1_CCNL2024_recupero2_01MonteSalari2018_2021_2023" description="Recupero incremento del 2,01% del monte salari dirigenza anno 2018 per gli anni 2021, 2022 e 2023 (non soggetto al limite del salario accessorio e al netto degli arretrati contrattuali liquidati)." riferimentoNormativo={RIF_CCNL_DIR_16072024_ART39C1} value={data.va_art39c1_CCNL2024_recupero2_01MonteSalari2018_2021_2023} onChange={handleChange} />
      ...
      <div className="fixed bottom-0 left-0 md:left-16 right-0 p-4 bg-[#fcf8f8]/80 backdrop-blur-sm border-t border-t-[#f3e7e8] shadow-[0_-4px_10px_rgba(0,0,0,0.05)] z-20">
        <div className="max-w-[960px] mx-auto flex justify-between items-center md:pl-48 xl:pl-20 2xl:pl-0">
